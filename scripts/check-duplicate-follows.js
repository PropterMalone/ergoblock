...
if (!HANDLE || !PASSWORD) {
  ...
  console.error(
    'Example: BSKY_HANDLE=you.bsky.social BSKY_PASSWORD=xxxx-xxxx-xxxx-xxxx node scripts/check-duplicate-follows.js'
  );
  process.exit(1);
}
...
async function main() {
  ...
  console.log(
    '  DELETE=1 BSKY_HANDLE=... BSKY_PASSWORD=... node scripts/check-duplicate-follows.js'
  );
