...
describe('Integration Tests', () => {
  ...
  describe('Complete temp block workflow', () => {
    it('should add a temp block and notify background', async () => {
      const { addTempBlock, getTempBlocks } = await import('../platform/storage');
    ...
    it('should add a temp mute and notify background', async () => {
      const { addTempMute, getTempMutes } = await import('../platform/storage');
    ...
    it('should track multiple blocks and mutes', async () => {
      const { addTempBlock, addTempMute, getTempBlocks, getTempMutes } =
  ...
  describe('Expiration workflow', () => {
    it('should identify expired entries', async () => {
      const { removeAllExpiredBlocks, getTempBlocks } = await import('../platform/storage');
    ...
    it('should clean up expired mutes', async () => {
      const { removeAllExpiredMutes, getTempMutes } = await import('../platform/storage');
  ...
  describe('History tracking workflow', () => {
    it('should record block action in history', async () => {
      const { addHistoryEntry, getActionHistory } = await import('../platform/storage');
  ...
  describe('Options persistence workflow', () => {
    it('should persist and retrieve options', async () => {
      const { getOptions, setOptions } = await import('../platform/storage');
    ...
    it('should use default options when none stored', async () => {
      const { getOptions } = await import('../platform/storage');
  ...
  describe('Edge cases', () => {
    ...
    it('should handle removing non-existent block', async () => {
      const { removeTempBlock, getTempBlocks } = await import('../platform/storage');
