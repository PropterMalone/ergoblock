...
import { checkCarCacheStatus, getCarDataSmart } from '../domains/carService.js';
import * as carCache from '../platform/carCache.js';
import * as carRepo from '../domains/carRepo.js';

vi.mock('../platform/carCache.js');
vi.mock('../domains/carRepo.js');
