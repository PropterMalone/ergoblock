...
export function FirstRunEmptyState({ surface }: FirstRunEmptyStateProps): JSX.Element {
  return (
    <div class="first-run-empty-state">
      ...
      <p>
        This extension lets you temporarily block or mute people on Bluesky. Blocks and mutes you
        create will automatically expire after the time you choose.
      </p>
      <div class="first-run-steps">
        ...
        <ol>
          <li>
            ...
            and find someone's profile
          </li>
          <li>
            Click the <strong>...</strong> menu
          </li>
          <li>
            Choose <strong>Block</strong> or <strong>Mute</strong> - you'll see duration options
          </li>
        </ol>
      </div>
      {surface === 'manager' && (
