...
**REVIEW QUEUE - Catch Up on Outside Actions**

Review blocks and mutes made outside ErgoBlock (Bluesky app, other tools):
• Automatically detects untracked permanent blocks and mutes
• Card view for quick review, table view for bulk management
• Assign durations or keep permanent with one click
• Backfill button to pull in all pre-existing permanent blocks
• Brings outside actions under ErgoBlock management
...
• Auto-rectification: detects and fixes stuck or failed operations
• Robust token refresh handling across long sessions
• Reduced noise from expected errors on cold boot
...
6. Check the Review Queue to manage blocks made outside ErgoBlock
...
## Tags/Keywords
bluesky, block, mute, temporary, moderation, social media, timeout, blocklist, amnesty, review
...
Smarter Bluesky moderation: temporary blocks/mutes that auto-expire, Review Queue for outside actions, Amnesty mode to review past decisions, and tools to clean up block lists.
